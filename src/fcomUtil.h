...
#define FCOM_MASK_AREA_FEEH              ((unsigned long)0x00000011)
#define FCOM_MASK_AREA_BSYS              ((unsigned long)0x00000012)
#define FCOM_MASK_AREA_CLTS              ((unsigned long)0x00000013)
#define FCOM_MASK_AREA_LTUS              ((unsigned long)0x00000014)
#define FCOM_MASK_AREA_UNDS              ((unsigned long)0x00000015)
#define FCOM_MASK_AREA_DMPS              ((unsigned long)0x00000016)
#define FCOM_MASK_AREA_FEES              ((unsigned long)0x00000017)
#define FCOM_MASK_AREA_NEH1              ((unsigned long)0x00000018)
#define FCOM_MASK_AREA_FEH1              ((unsigned long)0x00000019)
#define FCOM_MASK_AREA_FB01              ((unsigned long)0x0000001A)  
#define FCOM_MASK_AREA_FB02              ((unsigned long)0x0000001B)
#define FCOM_MASK_AREA_FB03              ((unsigned long)0x0000001C)
#define FCOM_MASK_AREA_FB04              ((unsigned long)0x0000001D)
#define FCOM_MASK_AREA_FB05              ((unsigned long)0x0000001E)
/* Detectors SID is
